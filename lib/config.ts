...
export const chatbotConfig = {
  ...
  name: "ChatGPTX AI Assistant",

  // Initial message (supports {{choice:}} and {{link:}} syntax)
  welcomeMessage:
    "Hello! I'm your ChatGPTX AI Assistant. What can I help you with today? {{choice:See Features}} {{link:https://github.com/yourusername/ChatGPTX|Source Code}}",

  // UI customization
  ui: {
    // Chat window title
    windowTitle: "ChatGPTX AI Assistant",

    // Placeholder text for input
    inputPlaceholder: "Message ChatGPTX AI Assistant...",
